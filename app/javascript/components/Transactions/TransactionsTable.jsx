...
const TransactionsTable = (props) => {
  ...
  const accountSelectCell = (
    <td className="account-cell">
      <select name="ACCOUNT_ID" className="account-select custom-select-sm" value={accountId} onChange={onChange}>
  ...
  const categorySelectCell = (
    <td className="category-cell">
      <select name="CATEGORY_ID" className="category-select custom-select-sm" value={categoryId} onChange={onChange}>
  ...
  const amountOutInputCell = (
    <td className="amount-out-cell">
      <input type="text" name="AMOUNT_OUT" className="amount-out-input" value={amountOut} onChange={onChange} />
    </td>
  );
  // ------------
